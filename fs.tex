...
\newenvironment{define}{\color{cGray}}{} 
\newcommand{\cdef}[1]{\begin{define}#1\end{define}}
...
\newenvironment{dtabular} {
  \begin{tabular}{>{\begin{define}}l<{\end{define}} >{\begin{define}}l<{\end{define}}}
}  
{
  \end{tabular}
}
...
\newenvironment{ddtabular} {
  \begin{center}
  \begin{tabular}{>{\begin{define}}l<{\end{define}} >{\begin{define}}l<{\end{define}} | >{\begin{define}}l<{\end{define}} >{\begin{define}}l<{\end{define}}}
}  
{
  \end{tabular}
  \end{center}
...
\tikzset{%
  ...
  point/.style    = {coordinate}, % Output
  gain/.style     = {draw, thick, isosceles triangle, minimum height = 1em, isosceles triangle apex angle=60},
  rgain/.style    = {draw, thick, isosceles triangle, minimum height = 1em, isosceles triangle apex angle=60},
  sampler/.style = {minimum height = 0.6cm, minimum width = 0.6cm, path picture={
	  \draw [fill=black] (path picture bounding box.east) + (-0.05cm,0cm) circle (0.05cm);
	  \draw (path picture bounding box.east) + (-0.05cm,0cm) -- ++(155:0.55cm);
	  \draw [thick](path picture bounding box.west) + (0cm,-0.04cm) -- ++(0cm, 0.08cm);
	}},
	impulsetrain/.style = {draw, thick, rectangle, minimum height=2.5em, minimum width=3.5em, path picture = {
		\draw [line width=0.018cm] (path picture bounding box.west) + (0.75em,-0.7em) -- ++ (2.75em,-0.7em);
		\draw [line width=0.018cm, ->, >=latex] (path picture bounding box.west) + (1.25em,-0.7em) -- ++(1.25em,0.7em);
		\draw [line width=0.018cm, ->, >=latex] (path picture bounding box.west) + (1.75em,-0.7em) -- ++(1.75em,0.7em);
		\draw [line width=0.018cm, ->, >=latex] (path picture bounding box.west) + (2.25em,-0.7em) -- ++(2.25em,0.7em);
	}}
}
